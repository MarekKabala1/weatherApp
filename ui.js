...
const createElement = () => {
	...
	section.childNodes.forEach((item) => {
		...
		img.innerHTML = '<img src="img-svg/01d.svg" alt="sun" />';
...
const updateUi = async (data) => {
	const setDay = () => {
		...
		// day one
		// prettier-ignore
		divOne.innerHTML = `<p class="day">${
			weekday[new Date(data.daily[1].dt * 1000).getDay()]
		}</p>
    <div><img src="img-svg/${data.daily[1].weather[0].icon}.svg" alt="${
			data.daily[1].weather[0].main
		}"></div>
    <p class="weekTemp">High ${data.daily[1].temp.max.toFixed(
			1
		)}&#176;Low ${data.daily[1].temp.min.toFixed(1)}&#176 C</p>`;
		//day two
		// prettier-ignore
		divTwo.innerHTML =
    `<p class="day">${weekday[new Date(data.daily[2].dt * 1000).getDay()]}</p>
    <div><img src="img-svg/${data.daily[2].weather[0].icon}.svg" alt="${data.daily[2].weather[0].main}"></div>
    ...
    <div><img src="img-svg/${data.daily[3].weather[0].icon}.svg" alt="${data.daily[3].weather[0].main}"></div>
    ...
    <div><img src="img-svg/${data.daily[4].weather[0].icon}.svg" alt="${data.daily[4].weather[0].main}"></div>
    ...
    <div><img src="img-svg/${data.daily[5].weather[0].icon}.svg" alt="${data.daily[5].weather[0].main}"></div>
    ...
    <div><img src="img-svg/${data.daily[6].weather[0].icon}.svg" alt="${data.daily[6].weather[0].main}"></div>
